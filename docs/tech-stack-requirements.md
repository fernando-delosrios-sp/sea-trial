...
| Variable | Required | Description |
|----------|----------|-------------|
| Agent-service URL | Yes | Public HTTPS base URL of deployed agent-service |
...
- [ ] App created at [api.slack.com/apps](https://api.slack.com/apps)
- [ ] Custom app install permitted for developers
- [ ] Outbound HTTPS allowed (Slack Functions → Render URL)
- [ ] Task 1 spike: `canvases.create` + `slacklists.create` return 200
